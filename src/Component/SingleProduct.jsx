...
export default function SingleProduct() {
    ...
    async function addToCart() {
        try {
            ...
            const item = cartData.find((x) => x.productid === id && x.userid === localStorage.getItem("userid"));
            console.log(item)
            if (!item) {
    ...
    async function addToWishlist() {
        try {
            ...
            // console.log(cartData);
            // Check if the product already exists in the cart
            const item = wishlistData.find((x) => x.productid === id && x.userid === localStorage.getItem("userid"));
            console.log(item)
            if (!item) {
                // If the product does not exist in the cart, add it
                const newItem = {
