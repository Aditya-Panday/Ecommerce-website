...
export default function Sidebar() {
    return (
        <div className="list-group">
            ...
            <Link to="/admin/brands" className="list-group-item list-group-item-action bg-primary mb-1"><i className='fa fa-copyright fs-3'></i><span className='float-end'>Brands</span></Link>
