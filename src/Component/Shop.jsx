...
export default function Shop() {
    ...
    function postSearch(e) {
        ...
        setProduct(ProductStateData.filter((x) => x.name.toLowerCase().includes(srch) || x.maincategory.toLowerCase() === srch || x.subcategory.toLowerCase() === srch || x.brand.toLowerCase() === srch || x.color.toLowerCase() === srch || x.size.toLowerCase() === srch || x.description.toLowerCase().includes(srch)))
    }
            ...
            <div className='row'>
                <div className="col-md-3">
                    <div className="list-group mb-3">
                        <button className="list-group-item list-group-item-action bg-secondary text-light" aria-current="true">
                            Maincategory
                        </button>
                        <button className="list-group-item list-group-item-action" onClick={() => categoryFilter('', sc, br)}>All</button>
                        {
                    ...
                    <div className="list-group mb-3">
                        ...
                        <button className="list-group-item list-group-item-action" onClick={() => categoryFilter(mc, '', br)}>All</button>
                        {
                    ...
                    <div className="list-group mb-3">
                        ...
                        <button className="list-group-item list-group-item-action" onClick={() => categoryFilter(mc, sc, '')}>All</button>
                        {
                    ...
                    <div className='mb-3'>
                        ...
                        <div className='d-flex'>
                            <input type="number" name="min" value={min} onChange={(e) => setMin(e.target.value)} className="form-control" placeholder='Min Amount' />
                            <input type="number" name="max" value={max} onChange={(e) => setMax(e.target.value)} className="form-control" placeholder='Max Amount' />
                        </div>
                    ...
                    <div className="row">
                        {
                            product.map((item, index) => {
                                return <div key={index} className="col-md-4 col-sm-6 col-12">
                                    <div className="card p-2">
                                        <div className="product-card position-relative">
                                            <div className="image-holder">
                                                <img src={`/images/${item.pic[0]}`} alt="product-item" className="img-fluid" style={{ height: 200, width: "100%" }} />
                                            </div>
